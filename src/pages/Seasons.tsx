...
const SEASONS: SeasonCard[] = [
  {
    ...
    countries: "12 pays · CH→GR→IN→MA→IT→JP→MX→PE→TR→ET→KH→DE",
    theme: "Surveillance · Réseaux · Infiltration",
    price: 29,
    reward: "Clé WATCHER — ACCESS LEVEL 1",
    rewardIcon: "🔐",
    features: [
  ...
  },
  {
    ...
    countries: "12 pays · US→CA→BR→AR→ES→PT→GB→NL→SE→PL→RO→IL",
    theme: "Organisations internationales · Zones stratégiques",
    price: 29,
    reward: "Clé ARCHITECT — ACCESS LEVEL 2",
    rewardIcon: "🗺",
    features: [
  ...
  },
  {
    ...
    countries: "12 pays · CN→KR→SG→AU→NZ→ZA→EG→AE→TH→VN→ID→CL",
    theme: "Crises contrôlées · Routes énergétiques · Pouvoir invisible",
    price: 29,
    reward: "Clé BREACH — ACCESS LEVEL 3",
    rewardIcon: "⚡",
    features: [
      "12 nouveaux pays débloqués",
  ...
  },
  {
    ...
    countries: "12 pays · NO→FI→CZ→HU→QA→SA→KZ→MN→PH→MY→BE→FR",
    theme: "Pays Stratégiques · Assemblage final",
    price: 29,
    reward: "Clé OMEGA — ACCESS LEVEL 4 + Carte mondiale révélée",
    rewardIcon: "🧩",
    features: [
...
const BUNDLE: SeasonCard = {
  ...
  tagline: "Les 4 saisons · 48 pays · Accès à vie",
  countries: "48 pays · Toutes les saisons",
