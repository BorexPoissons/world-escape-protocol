...
const SEASON_INFO: Record<string, {
  ...
  season_1: {
    ...
    description:
      "Vous avez prouvé que vous saviez regarder. Mais derrière la porte, un réseau vous surveille. 12 pays. L'interférence commence.",
    price: "29",
    features: [
      "12 pays débloqués — opérations sur 4 continents",
      "Missions narratives avec timer 120s et 3 vies",
      "Fragments V-01 à V-12 + Assemblage de clé",
      "Mini-jeu final π",
  ...
  season_2: {
    ...
    description:
      "Les connexions se dessinent. Vous remontez aux origines du Protocole. 12 pays. La vérité a un prix.",
    price: "29",
    features: [
      "12 nouveaux pays débloqués",
      "Découverte de l'origine du Protocole",
      "Fragments + Assemblage de clé 2",
  ...
  season_3: {
    ...
    description:
      "La réalité commence à se déstabiliser. Les certitudes s'effondrent. 12 pays. Rien n'est ce qu'il paraît.",
    price: "29",
    features: [
      "12 nouveaux pays débloqués",
      "La réalité se déstabilise",
      "Fragments + Assemblage de clé 3",
  ...
  season_4: {
    ...
    description:
      "Tout converge. L'assemblage final commence. 12 pays. La révélation ultime vous attend.",
    price: "29",
    features: [
      "12 derniers pays débloqués",
  ...
  full_bundle: {
    ...
    description:
      "Les 4 saisons. 48 pays. Du Signal Initial au Protocole Final. L'intégralité de l'aventure en un seul accès.",
    price: "99",
    features: [
      "Les 4 saisons débloquées — 48 pays",
